...
export default function SignInPage() {
  return (
    <Container>
      <div className='grid w-full flex-grow items-center bg-black px-4 sm:justify-center border  text-white rounded-lg mt-20'>
        <SignIn.Root>
          <SignIn.Step
            name='start'
          ...
          >
            ...
            <Clerk.Field name='identifier'>
              ...
              <Clerk.Input
                ...
                required
                placeholder='Email'
                className='w-full border-b border-neutral-200 bg-transparent pb-2 text-sm text-neutral-150 outline-none placeholder:text-neutral-400  hover:border-neutral-300 focus:border-neutral-600 data-[invalid]:border-red-600 data-[invalid]:text-red-600'
              />
            ...
            <div className=''>
              <p className='mb-4 text-center text-sm/5 text-neutral-400'>
            ...
            <p className='text-center text-sm text-neutral-400'>
              ...
              <Link
                href='/sign-up'
                className='rounded px-1 py-0.5 text-neutral-400 outline-none hover:bg-neutral-700 focus-visible:bg-neutral-100'
              >
                Sign up
              </Link>
            </p>
          ...
          >
            <SignIn.Strategy name='email_code'>
              <header className='text-center'>
                ...
                <h1 className='mt-4 text-xl font-medium tracking-tight text-neutral-150'>
                  Verify email code
                </h1>
              </header>
              <Clerk.GlobalError className='block text-sm text-red-600' />
              <Clerk.Field name='code'>
                ...
                <Clerk.Input
                  ...
                  className='w-full border-b border-neutral-200 bg-transparent pb-2 text-sm/6 text-neutral-150 outline-none placeholder:text-neutral-400 hover:border-neutral-300 focus:border-neutral-600 data-[invalid]:border-red-600 data-[invalid]:text-red-600'
                />
                <Clerk.FieldError className='mt-2 block text-xs text-red-600' />
              </Clerk.Field>
              <SignIn.Action
